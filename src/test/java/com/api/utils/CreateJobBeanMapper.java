...
// We will give the bean and it will create the payload for CreateJobAPI
	...
	//Util Class
		...
		public static CreateJobPayload mapper(CreateJobBean bean) {
			// Bean ---Converts to----> CreateJobPayload Object
			...
			CreateJobPayload payload = new CreateJobPayload(mstServiceLocationId, mstPlatformId, mstWarrentyStatusId, oemId, customer, customerAddress, customerProduct, problemsList);
